    ...
    <div class="container">
        <div class="columns is-multiline">
            ...
            <div class="column is-4" >
                <div class="box" style=" background: linear-gradient(135deg, #71b7e6, #9b59b6 ); border-style:solid; color: black;">
                    ...
                    <p>Max 5 leads</p>
                    <hr>
                    <button @click="subscribe('free')" class="button is-primary" style="background-color: black; color: whitesmoke;" >Subscribe</button>
                </div>
            </div>

            <div class="column is-4" >
                <div class="box" style=" background: linear-gradient(135deg, #71b7e6, #9b59b6 ); border-style:solid; color: black;">
                    <h2 class="title">Small team</h2>
                    <h4 class="is-size-3">$10</h4>

                    <p>Max 15 clients</p>
                    <p>Max 15 leads</p>
                    <hr>
                    <button @click="subscribe('smallteam')" class="button is-primary" style="background-color: black; color: whitesmoke;">Subscribe</button>
                </div>
            </div>

            <div class="column is-4">
                <div class="box" style=" background: linear-gradient(135deg, #71b7e6, #9b59b6 ); border-style:solid; color: black;">
                    <h2 class="title">Big team</h2>
                    <h4 class="is-size-3">$25</h4>

                    <p>Max 50 clients</p>
                    <p>Max 50 leads</p>
                    <hr>
                    <button @click="subscribe('bigteam')" class="button is-primary" style="background-color: black; color: whitesmoke;">Subscribe</button>
                </div>
            </div>
