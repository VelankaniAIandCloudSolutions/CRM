<template>
  <div class="container">
    ...
    <div class="buttons">
      <router-link :to="{ name: 'EditClient', params: { id: this.$route.params.client_id }}" class="button is-link is-outlined is-rounded" style="color: black;">Edit</router-link>
      <button class="button is-danger is-rounded is-outlined" @click="deleteClient">Delete</button>
    </div>
  ...
  <td style="border-style: solid; border-color: black;">
    ...
    <router-link :to="{ name: 'AddNote', params: { client_id: client.id }}" class="button is-info mb-6" style="color: black;">Add Note</router-link>
    <table class="table is-fullwidth is-bordered">
      <tbody>
        <tr v-for="note in notes" v-bind:key="note.id">
          ...
          <td>
            <router-link :to="{ name: 'EditNote', params: { id: this.$route.params.client_id , note_id: note.id }}" class="button is-info mt-6" style="color: black;">Edit Note</router-link>
          </td>
        </tr>
      </tbody>
    </table> -->
