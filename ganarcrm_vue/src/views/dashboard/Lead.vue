...
<template>
    <div class="container">
        ...
        <router-link :to="{ name: 'AddNote' , params: { id: lead.id } }" class="button is-info mb-6" style="color: black;">Add Notes</router-link>
        <table class="table is-fullwidth is-bordered">
            <tbody>
                <tr v-for="notes in notess" v-bind:key="notes.id">
                    ...
                    <td>
                        <router-link :to="{ name: 'EditNotes', params: { id: lead.id, notes_id: notes.id } }" class="button is-info mt-6" style="color: black;">Edit Note</router-link>
                    </td>
                </tr>
            </tbody>
        </table> 
