...
import AddNotes from '../views/dashboard/AddNotes.vue'
import EditNotes from '../views/dashboard/EditNotes.vue'
...
import Quotes from '../views/dashboard/Quotes.vue'
import Quote from '../views/dashboard/Quote.vue'
import AddQuote from '../views/dashboard/AddQuote.vue'
...
const routes = [
  ...
  {
    path: '/dashboard/quotes/:id/thankyouu',
    name: 'QuoteThankYou',
  ...
  {
    path: '/dashboard/accepted_quotes',
    name: 'AcceptedQuotes',
  ...
  {
    path: '/dashboard/rejected_quotes',
    name: 'RejectedQuotes',
    component: RejectedQuotes,
    meta: {
      requireLogin: true
    }
  },
  {
    path: '/dashboard/quotes/:id/mail',
    name: 'Email',
    component: Email,
    meta: {
      requireLogin: true
  ...
  {
    path: '/dashboard/leads/:id/add-notes',
    name: 'AddNotes',
    component: AddNotes,
    meta: {
      requireLogin: true
  ...
  {
    path: '/dashboard/leads/:id/edit-notes/:notes_id',
    name: 'EditNotes',
    component: EditNotes,
    meta: {
      requireLogin: true
